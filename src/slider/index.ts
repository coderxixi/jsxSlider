import {getRandomNumberByRange,removeClass,createElement,getRandomImg,createCanvas,draw,createImg,addClass} from "@/utils/index"
 ...
 private fail:()=>{};
  ...
  constructor(el:HTMLElement,private blockCtx:any, private slider:HTMLElement, private canvasCtx:any, success:()=>{},fail:()=>{},private y: number,private x: number,private ll:number,private r:number,private w:number=310,private h:number=155,private l:number){
      this.el=el;
